...
\begin{itemize}
    ...
    \item \parbox[t]{\linewidth}{\vspace*{-1.2em}\begin{nospaceflalign*}
            ...
            | \, | \, m \, | > \text{NUM\_EMOTION\_KINDS}
            \Rightarrow \text{E-EST\_TOO\_MANY\_VALUES\_FOR\_STATE} &\\
            | \, \nexists x \in m \rightarrow x \geq 0 \Rightarrow
            \text{E-EST\_ALL\_MAX\_VALUES\_ARE\_ZERO} \, )
        \end{nospaceflalign*}
    }
...
\begin{itemize}
    ...
    \item \parbox[t]{\linewidth}{\vspace*{-1.2em}\begin{nospaceflalign*}
            \text{transition: } &\mathit{max}.\mathit{emotion},
            \mathit{intensities}.\mathit{emotion} := M,
            \text{ValidateIntensityOf}(\mathit{emotion}) &\\
