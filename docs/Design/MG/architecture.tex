...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{figures/emgineArch_internalComponents.eps}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/emgineArch_componentRelations.eps}
